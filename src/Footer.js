        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-12 col-md-4 text-center text-md-end footer-social-icons">
              <a href="https://www.facebook.com/" className="fs-4"><i className="fab fa-facebook"></i></a>
              <a href="https://www.facebook.com/" className="fs-4"><i className="fab fa-twitter"></i></a>
              <a href="https://www.facebook.com/" className="fs-4"><i className="fab fa-instagram"></i></a>
              <a href="https://www.facebook.com/" className="fs-4"><i className="fab fa-whatsapp"></i></a>
              <a href="https://www.facebook.com/" className="fs-4"><i className="fas fa-envelope"></i></a>
            </div>
          </div>
        </div>
      </footer>
